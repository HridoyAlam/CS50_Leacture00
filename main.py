...
class Game:
    ...
    def display_score(self):
        ...
        score = font.render(f"Score: {self.snake.length}", True, TEXT_COLOR)
        self.surface.blit(score,(850, 10))

    def show_game_over(self):
        self.surface.fill(BACKGROUND_COLOR)
        font = pygame.font.SysFont('arial', 30)
        line1 = font.render(f"GAME IS OVER! YOUR SCORE IS {self.snake.length}", True, TEXT_COLOR)
        self.surface.blit(line1, (200,300))
        line2 = font.render("TO PLAY AGAIN PRESS ENTER || TO EXIT PRESS ESCAPE", True, TEXT_COLOR)
